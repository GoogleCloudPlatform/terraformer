...
func (g TargetHttpProxiesGenerator) Generate(zone string) error {
	...
	err = terraform_utils.GenerateTf(resources, "TargetHttpProxies", region, "google")
	if err != nil {
		return err
	}
	return nil
