...
func (g HttpsHealthChecksGenerator) Generate(zone string) error {
	...
	err = terraform_utils.GenerateTf(resources, "HttpsHealthChecks", region, "google")
	if err != nil {
		return err
	}
	return nil
