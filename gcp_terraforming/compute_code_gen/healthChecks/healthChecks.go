...
func (HealthChecksGenerator) createResources(HealthChecksList *compute.HealthChecksListCall, ctx context.Context, region string) []terraform_utils.TerraformResource {
...
func (g HealthChecksGenerator) Generate(zone string) error {
	...
	resources := g.createResources(HealthChecksList, ctx, region)
