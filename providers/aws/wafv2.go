...
func (g *Wafv2Generator) loadWebACL(svc *wafv2.Client) error {
	//svc.GetWebACL(context.TODO(), &wafv2.GetWebACLInput{})
	output, err := svc.ListWebACLs(context.TODO(), &wafv2.ListWebACLsInput{Scope: types.ScopeCloudfront})
	if err != nil {
		return err
	}
...
func (g *Wafv2Generator) loadIPSet(svc *wafv2.Client) error {
	output, err := svc.ListIPSets(context.TODO(), &wafv2.ListIPSetsInput{Scope: types.ScopeCloudfront})
	if err != nil {
		return err
	}
...
func (g *Wafv2Generator) loadRegexPatternSets(svc *wafv2.Client) error {
	//svc.GetRegexPatternSet(context.TODO(), &wafv2.GetRegexPatternSetInput{})
	output, err := svc.ListRegexPatternSets(context.TODO(), &wafv2.ListRegexPatternSetsInput{Scope: types.ScopeCloudfront})
	if err != nil {
		return err
	}
...
func (g *Wafv2Generator) loadWafRuleGroups(svc *wafv2.Client) error {
	output, err := svc.ListRuleGroups(context.TODO(), &wafv2.ListRuleGroupsInput{Scope: types.ScopeCloudfront})
	if err != nil {
		return err
	}
