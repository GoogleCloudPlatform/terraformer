...
// Using the Client
//
// To use Amazon Cognito Identity Provider with the SDK use the New function to create
...
//
// See the Amazon Cognito Identity Provider client for more information on
