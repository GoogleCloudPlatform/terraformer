...
// SuspendExecutionPlanInstance invokes the emr.SuspendExecutionPlanInstance API synchronously
// api document: https://help.aliyun.com/api/emr/suspendexecutionplaninstance.html
func (client *Client) SuspendExecutionPlanInstance(request *SuspendExecutionPlanInstanceRequest) (response *SuspendExecutionPlanInstanceResponse, err error) {
	response = CreateSuspendExecutionPlanInstanceResponse()
	err = client.DoAction(request, response)
	return
}

// SuspendExecutionPlanInstanceWithChan invokes the emr.SuspendExecutionPlanInstance API asynchronously
// api document: https://help.aliyun.com/api/emr/suspendexecutionplaninstance.html
...
func (client *Client) SuspendExecutionPlanInstanceWithChan(request *SuspendExecutionPlanInstanceRequest) (<-chan *SuspendExecutionPlanInstanceResponse, <-chan error) {
	responseChan := make(chan *SuspendExecutionPlanInstanceResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.SuspendExecutionPlanInstance(request)
		if err != nil {
			errChan <- err
		} else {
...
// SuspendExecutionPlanInstanceWithCallback invokes the emr.SuspendExecutionPlanInstance API asynchronously
// api document: https://help.aliyun.com/api/emr/suspendexecutionplaninstance.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) SuspendExecutionPlanInstanceWithCallback(request *SuspendExecutionPlanInstanceRequest, callback func(response *SuspendExecutionPlanInstanceResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *SuspendExecutionPlanInstanceResponse
		var err error
		defer close(result)
		response, err = client.SuspendExecutionPlanInstance(request)
...
func CreateSuspendExecutionPlanInstanceRequest() (request *SuspendExecutionPlanInstanceRequest) {
	request = &SuspendExecutionPlanInstanceRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Emr", "2016-04-08", "SuspendExecutionPlanInstance", "emr", "openAPI")
	return
}
...
func CreateSuspendExecutionPlanInstanceResponse() (response *SuspendExecutionPlanInstanceResponse) {
	response = &SuspendExecutionPlanInstanceResponse{
