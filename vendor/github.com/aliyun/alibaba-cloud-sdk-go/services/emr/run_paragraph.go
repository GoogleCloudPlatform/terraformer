...
// RunParagraph invokes the emr.RunParagraph API synchronously
// api document: https://help.aliyun.com/api/emr/runparagraph.html
...
// RunParagraphWithChan invokes the emr.RunParagraph API asynchronously
// api document: https://help.aliyun.com/api/emr/runparagraph.html
...
// RunParagraphWithCallback invokes the emr.RunParagraph API asynchronously
// api document: https://help.aliyun.com/api/emr/runparagraph.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateRunParagraphRequest() (request *RunParagraphRequest) {
	...
	request.InitWithApiInfo("Emr", "2016-04-08", "RunParagraph", "emr", "openAPI")
	return
}
