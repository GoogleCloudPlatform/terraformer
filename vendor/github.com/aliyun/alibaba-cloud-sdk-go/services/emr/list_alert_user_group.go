...
// ListAlertUserGroup invokes the emr.ListAlertUserGroup API synchronously
// api document: https://help.aliyun.com/api/emr/listalertusergroup.html
func (client *Client) ListAlertUserGroup(request *ListAlertUserGroupRequest) (response *ListAlertUserGroupResponse, err error) {
	response = CreateListAlertUserGroupResponse()
	err = client.DoAction(request, response)
	return
}

// ListAlertUserGroupWithChan invokes the emr.ListAlertUserGroup API asynchronously
// api document: https://help.aliyun.com/api/emr/listalertusergroup.html
...
func (client *Client) ListAlertUserGroupWithChan(request *ListAlertUserGroupRequest) (<-chan *ListAlertUserGroupResponse, <-chan error) {
	responseChan := make(chan *ListAlertUserGroupResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.ListAlertUserGroup(request)
		if err != nil {
			errChan <- err
		} else {
...
// ListAlertUserGroupWithCallback invokes the emr.ListAlertUserGroup API asynchronously
// api document: https://help.aliyun.com/api/emr/listalertusergroup.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
func (client *Client) ListAlertUserGroupWithCallback(request *ListAlertUserGroupRequest, callback func(response *ListAlertUserGroupResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListAlertUserGroupResponse
		var err error
		defer close(result)
		response, err = client.ListAlertUserGroup(request)
...
func CreateListAlertUserGroupRequest() (request *ListAlertUserGroupRequest) {
	request = &ListAlertUserGroupRequest{
		RpcRequest: &requests.RpcRequest{},
	}
	request.InitWithApiInfo("Emr", "2016-04-08", "ListAlertUserGroup", "emr", "openAPI")
	return
}
...
func CreateListAlertUserGroupResponse() (response *ListAlertUserGroupResponse) {
	response = &ListAlertUserGroupResponse{
